...
public class ProductController {
    ...
    public ResponseEntity<List<Product>> getProducts() {
        ...
        ResponseEntity<List<Product>> response = restTemplate.exchange(serviceOneURL, HttpMethod.GET,
    ...
    public ResponseEntity<Map> createProduct(@RequestBody Product product) {
        ...
        // query parameters.
//        UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(serviceOneURL)
//                .queryParam("id", product.getProductID()).queryParam("name", product.getProductName())
//                .queryParam("price", product.getProductPrice());
                //.queryParam("image", product.getProductPrice());
...
//        return response;
        ...
        ResponseEntity<Map> response = restTemplate.exchange(serviceOneURL, HttpMethod.POST, request,
                Map.class);
        return response;
    }
    ...
    public ResponseEntity<Product> updateProduct(@RequestBody Product product) {
        ...
        HttpEntity<Product> request = new HttpEntity<>(product);
        ResponseEntity<Product> response = restTemplate.exchange(serviceOneURL, HttpMethod.PUT, request,
                Product.class);
        return response;
    }
    ...
    public ResponseEntity<Map> deleteProduct(@PathVariable("id") Long id) {
        ...
        ResponseEntity<Map> response = restTemplate.exchange((serviceOneURL + "/" + id), HttpMethod.DELETE,
                HttpEntity.EMPTY, Map.class);
        return response;
    }
}
